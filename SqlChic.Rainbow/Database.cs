...
namespace SqlChic.Rainbow
{
    ...
    public abstract class Database<TDatabase> : IDisposable where TDatabase : Database<TDatabase>, new()
    {
        ...
        public async Task<SqlMapper.GridReader> QueryMultipleAsync(string sql, dynamic param = null, DbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {

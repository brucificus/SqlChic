...
namespace SqlChic
{
	...
	public class CommandDefinition
	{
		...
		/// </summary>
		public CommandDefinition(string commandText, object parameters = null, DbTransaction transaction = null, int? commandTimeout = null,
		...
		internal DbCommand SetupCommand(DbConnection cnn, Action<DbCommand, object> paramReader)
		{
		...
		static SqlMapper.Link<Type, Action<DbCommand, bool>> bindByNameCache;
		static Action<DbCommand, bool> GetBindByName(Type commandType)
		{
			if (commandType == null) return null; // GIGO
			Action<DbCommand, bool> action;
			if (SqlMapper.Link<Type, Action<DbCommand, bool>>.TryGet(bindByNameCache, commandType, out action))
			{
				return action;
			}
			...
			// cache it            
			SqlMapper.Link<Type, Action<DbCommand, bool>>.TryAdd(ref bindByNameCache, commandType, ref action);
			return action;
		}
	}
    ...
    static partial class SqlMapper
    {
		...
		internal
#endif
		interface IParameterLookup : IDynamicParameters
		{
			/// <summary>
...
this DbConnection cnn, string sql, dynamic param = null, DbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
)
        {
			...
			return ExecuteImplAsync(cnn, command);
		}
		/// <summary>
		/// Execute parameterized SQL  
		/// </summary>
		/// <returns>Number of rows affected</returns>
		public static Task<int> ExecuteAsync(this DbConnection cnn, CommandDefinition command)
		{
			return ExecuteImplAsync(cnn, command);
		}
		private static async Task<int> ExecuteImplAsync(this DbConnection cnn, CommandDefinition command)
		{
            ...
            if (multiExec != null && !(multiExec is string))
            {
				if ((command.Flags & CommandFlags.Pipelined) != 0)
				{
					...
					return await ExecuteMultiImplAsync(cnn, command, multiExec);
				}
			...
			return await ExecuteCommandAsync(cnn, command, param == null ? null : info.ParamReader);
        }
...
this DbConnection cnn, string sql, dynamic param = null, DbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
		...
		/// or <see cref="DataSet"/>.
		/// </remarks>
		public static Task<IDataReader> ExecuteReaderAsync(this DbConnection cnn, CommandDefinition command)
		{
			return ExecuteReaderImplAsync(cnn, command);
		}
		...
		/// </summary>
		/// <returns>An <see cref="IDataReader"/> that can be used to iterate over the results of the SQL query.</returns>
		public static Task<IDataReader> ExecuteReaderAsync(this DbConnection cnn, string sql, object param)
		{
			return ExecuteReaderAsync(cnn, sql, param, null, null, null);
		}
		...
		/// </summary>
		/// <returns>An <see cref="IDataReader"/> that can be used to iterate over the results of the SQL query.</returns>
		public static Task<IDataReader> ExecuteReaderAsync(this DbConnection cnn, string sql, object param, DbTransaction transaction)
		{
			return ExecuteReaderAsync(cnn, sql, param, transaction, null, null);
		}
		...
		/// </summary>
		/// <returns>An <see cref="IDataReader"/> that can be used to iterate over the results of the SQL query.</returns>
		public static Task<IDataReader> ExecuteReaderAsync(this DbConnection cnn, string sql, object param, CommandType commandType)
		{
			return ExecuteReaderAsync(cnn, sql, param, null, null, commandType);
		}
		...
		/// </summary>
		/// <returns>An <see cref="IDataReader"/> that can be used to iterate over the results of the SQL query.</returns>
		public static Task<IDataReader> ExecuteReaderAsync(this DbConnection cnn, string sql, object param, DbTransaction transaction, CommandType commandType)
		{
			return ExecuteReaderAsync(cnn, sql, param, transaction, null, commandType);
		}
...
this DbConnection cnn, string sql, dynamic param = null, DbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
		...
		/// created per row, and a direct column-name===member-name mapping is assumed (case insensitive).
		/// </returns>
		public static IObservable<object> Query(
this DbConnection cnn, Type type, string sql, object param = null, DbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
)
		{
			if (type == null) throw new ArgumentNullException("type");
			var command = new CommandDefinition(sql, (object)param, transaction, commandTimeout, commandType, CommandFlags.None);
		...
		/// created per row, and a direct column-name===member-name mapping is assumed (case insensitive).
		/// </returns>
		public static IObservable<T> Query<T>(this DbConnection cnn, CommandDefinition command)
		{
			var data = QueryImpl<T>(cnn, command, typeof(T));
			return data;
		}
		...
		/// </summary>
		public static Task<GridReader> QueryMultipleAsync(this DbConnection cnn, string sql, object param, DbTransaction transaction)
		{
			return QueryMultipleAsync(cnn, sql, param, transaction, null, null);
		}

		/// <summary>
		/// Execute a command that returns multiple result sets, and access each in turn
		/// </summary>
		public static Task<GridReader> QueryMultiple(this DbConnection cnn, string sql, object param, CommandType commandType)
		{
			return QueryMultipleAsync(cnn, sql, param, null, null, commandType);
		}

		/// <summary>
		/// Execute a command that returns multiple result sets, and access each in turn
		/// </summary>
		public static Task<GridReader> QueryMultiple(this DbConnection cnn, string sql, object param, DbTransaction transaction, CommandType commandType)
		{
			return QueryMultipleAsync(cnn, sql, param, transaction, null, commandType);
		}
...
this DbConnection cnn, string sql, dynamic param = null, DbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
		...
		{
			var command = new CommandDefinition(sql, (object)param, transaction, commandTimeout, commandType, CommandFlags.Buffered);
			return QueryMultipleImplAsync(cnn, command);
		}
		/// <summary>
		/// Execute a command that returns multiple result sets, and access each in turn
		/// </summary>
		public static Task<GridReader> QueryMultipleAsync(this DbConnection cnn, CommandDefinition command)
		{
			return QueryMultipleImplAsync(cnn, command);
		}
        ...
        /// Execute a command that returns multiple result sets, and access each in turn
        /// </summary>
		private static async Task<GridReader> QueryMultipleImplAsync(this DbConnection cnn, CommandDefinition command)
        {
			object param = command.Parameters;
            ...
            try
            {
                if (wasClosed) await cnn.OpenAsync().ConfigureAwait(false);
        ...
        /// </summary>
		private static IObservable<T> QueryImpl<T>(this DbConnection cnn, CommandDefinition command, Type effectiveType)
        {
	        return Observable.Create<T>(async observer =>
		        {
					...
					try
					{
						...
						while (await reader.ReadAsync())
						{
							...
							{
								observer.OnNext((T)Convert.ChangeType(val, effectiveType));
							}
							else if (val == null || val is T)
							{
								observer.OnNext((T)val);
							}
							else
							{
								observer.OnNext((T)Convert.ChangeType(val, effectiveType));
...
this DbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, dynamic param = null, DbTransaction transaction = null, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        static IObservable<TReturn> MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(
            this DbConnection cnn, string sql, Delegate map, object param, DbTransaction transaction, string splitOn, int? commandTimeout, CommandType? commandType)
        {
			var command = new CommandDefinition(sql, (object)param, transaction, commandTimeout, commandType, CommandFlags.None);
		...
		static IObservable<TReturn> MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(this DbConnection cnn, CommandDefinition command, Delegate map, string splitOn, DbDataReader reader, Identity identity)
		{
		...
		internal
#endif
		static void ReplaceLiterals(this IParameterLookup parameters, DbCommand command)
		{
		...
		internal static void ReplaceLiterals(IParameterLookup parameters, DbCommand command, IList<LiteralToken> tokens)
		{
...
#pragma warning restore 0618
		...
		/// Internal use only
		/// </summary>
		public static Action<DbCommand, object> CreateParamInfoGenerator(Identity identity, bool checkForDuplicates, bool removeUnused)
		{
			return CreateParamInfoGenerator(identity, checkForDuplicates, removeUnused, GetLiteralTokens(identity.sql));
		}

		internal static Action<DbCommand, object> CreateParamInfoGenerator(Identity identity, bool checkForDuplicates, bool removeUnused, IList<LiteralToken> literals)
		{
...
#pragma warning restore 618
		...
		private static async Task<int> ExecuteCommandAsync(DbConnection cnn, CommandDefinition command, Action<DbCommand, object> paramReader)
		{
			DbCommand cmd = null;
			bool wasClosed = cnn.State == ConnectionState.Closed;
			try
		...
		private static async Task<IDataReader> ExecuteReaderImplAsync(DbConnection cnn, CommandDefinition command)
		{
			Action<DbCommand, object> paramReader = GetParameterReader(cnn, command);
            ...
            try
            {
				cmd = command.SetupCommand(cnn, paramReader);
				if (wasClosed) await cnn.OpenAsync();
				var reader = await cmd.ExecuteReaderAsync(wasClosed ? CommandBehavior.CloseConnection : CommandBehavior.Default);
				wasClosed = false;
				return reader;
            }
            finally
		...
		private static Action<DbCommand, object> GetParameterReader(DbConnection cnn, CommandDefinition command)
		{
			object param = command.Parameters;
...
#pragma warning restore 618
        ...
        public partial class GridReader : IDisposable
        {
			...
			/// Read the next grid of results
			/// </summary>
			public IObservable<object> Read(Type type)
			{
				if (type == null) throw new ArgumentNullException("type");
				if (reader == null) throw new ObjectDisposedException(GetType().FullName, "The reader has been disposed; this can happen after all data has been consumed");
				...
				var result = ReadDeferred<object>(deserializer.Func, typedIdentity, gridIndex);
				return result;
			}

			private IObservable<TReturn> MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(Delegate func, string splitOn)
			{
				...
				return SqlMapper.MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(null, default(CommandDefinition), func, splitOn, reader, identity)
...
#pragma warning restore 612, 618
	...
	sealed class DataTableHandler : SqlChic.SqlMapper.ITypeHandler
	{
	...
	/// Used to pass a DataTable as a TableValuedParameter
	/// </summary>
	sealed partial class TableValuedParameter : SqlChic.SqlMapper.ICustomQueryParameter
	{
		...
		void SqlMapper.ICustomQueryParameter.AddParameter(DbCommand command, string name)
		{
